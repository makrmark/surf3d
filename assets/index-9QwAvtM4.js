...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function Za(){return new Fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ds(),fragmentShader:`
		...
		`,blending:gn,depthTest:!1,depthWrite:!1})}function $a(){return new Fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ds(),fragmentShader:`
...
void main() {
	...
	gl_FragColor = pack2HalfToRGBA( vec2( mean, std_dev ) );
        ...
        `),wl.innerHTML=`Beach Balls × ${vr}`;const f=zt.getBoardPosition();Nm(f)?(Xt.background.lerp(new At(16777215),.1),Mr.classList.add("visible")):(Xt.background.lerp(new At(8900331),.1),Mr.classList.remove("visible"));const m=$.width/2;(Math.abs(zt.x)>m||zt.z<0||zt.z>$.length)&&Im(),Ns.render(Xt,Pn)}Cl();
